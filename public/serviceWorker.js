...
self.addEventListener('fetch', event => {
   ...
   if(!(event.request.url).startsWith('chrome-extension') && !(event.request.url).startsWith('https://firestore.googleapis') && !(event.request.url).startsWith('https://generativelanguage.googleapis.com')){
      event.respondWith(
